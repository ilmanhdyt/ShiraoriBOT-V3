...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    // Send menu dengan format sederhana (lebih reliable)
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        externalAdReply: {
          title: 'NIA-AI BOT',
          body: wm,
          thumbnailUrl: 'https://telegra.ph/file/d0a5a7c3d4c8e0f1b2e3f.jpg',
          sourceUrl: 'https://github.com/ilmanhdyt/nia-ai',
          mediaType: 1,
    ...
    console.log('\x1b[31m%s\x1b[0m', '✗ Menu Error:', e.message)
