// database/bankHelper.js
// ═══════════════════════════════════════════════════════════════════
//  Shared helper untuk bank, invest, crypto
// ═══════════════════════════════════════════════════════════════════
...
function addLog(user, type, amount, note = '') {
    ...
    if (user.bankLog.length > 30) user.bankLog = user.bankLog.slice(0, 30)
}
...
module.exports = { fmt, ensureBank, addLog, saveDB }
